...
class LazyParserLoader:
    ...
    def __init__(self):
        ...
        self.parser_mapping = {
            ...
            # 代码文件
            '.py': ('parsers.text_parser', 'TextParser'),
            '.js': ('parsers.text_parser', 'TextParser'),
            '.ts': ('parsers.text_parser', 'TextParser'),
            '.jsx': ('parsers.text_parser', 'TextParser'),
            '.tsx': ('parsers.text_parser', 'TextParser'),
            '.java': ('parsers.text_parser', 'TextParser'),
            '.c': ('parsers.text_parser', 'TextParser'),
            '.cpp': ('parsers.text_parser', 'TextParser'),
            '.h': ('parsers.text_parser', 'TextParser'),
            '.hpp': ('parsers.text_parser', 'TextParser'),
            '.cs': ('parsers.text_parser', 'TextParser'),
            '.rb': ('parsers.text_parser', 'TextParser'),
            '.go': ('parsers.text_parser', 'TextParser'),
            '.rs': ('parsers.text_parser', 'TextParser'),
            '.php': ('parsers.text_parser', 'TextParser'),
            '.swift': ('parsers.text_parser', 'TextParser'),
            '.kt': ('parsers.text_parser', 'TextParser'),
            '.sh': ('parsers.text_parser', 'TextParser'),
            '.bash': ('parsers.text_parser', 'TextParser'),
            '.zsh': ('parsers.text_parser', 'TextParser'),
            '.sql': ('parsers.text_parser', 'TextParser'),
            '.r': ('parsers.text_parser', 'TextParser'),
            '.m': ('parsers.text_parser', 'TextParser'),
            '.pl': ('parsers.text_parser', 'TextParser'),
            '.lua': ('parsers.text_parser', 'TextParser'),
            '.vim': ('parsers.text_parser', 'TextParser'),
            
            # 配置文件
            '.xml': ('parsers.text_parser', 'TextParser'),
            '.yaml': ('parsers.text_parser', 'TextParser'),
            '.yml': ('parsers.text_parser', 'TextParser'),
            '.toml': ('parsers.text_parser', 'TextParser'),
            '.ini': ('parsers.text_parser', 'TextParser'),
            '.cfg': ('parsers.text_parser', 'TextParser'),
            '.conf': ('parsers.text_parser', 'TextParser'),
            '.properties': ('parsers.text_parser', 'TextParser'),
            '.env': ('parsers.text_parser', 'TextParser'),
            '.gitignore': ('parsers.text_parser', 'TextParser'),
            '.dockerignore': ('parsers.text_parser', 'TextParser'),
            
            # Web文件
            '.html': ('parsers.text_parser', 'TextParser'),
            '.htm': ('parsers.text_parser', 'TextParser'),
            '.css': ('parsers.text_parser', 'TextParser'),
            '.scss': ('parsers.text_parser', 'TextParser'),
            '.sass': ('parsers.text_parser', 'TextParser'),
            '.less': ('parsers.text_parser', 'TextParser'),
